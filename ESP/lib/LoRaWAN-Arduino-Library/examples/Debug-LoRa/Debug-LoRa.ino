...
byte outStr[255];
byte recvStatus = 0;
int port, channel, freq, datarate, counterup, counterdown, power;
...
void loop() {
  ...
  if (millis() - previousMillis > interval) {
    ...
    datarate = lora.getDataRate();
    counterup = lora.getFrameCounter();
    power = lora.getTxPower();
    Serial.print(F("fport: "));    Serial.print(port); Serial.print(" ");
    Serial.print(F("Ch: "));    Serial.print(channel); Serial.print(" ");
    Serial.print(F("Freq: "));    Serial.print(freq); Serial.print(" ");
    Serial.print(F("DR: "));    Serial.print(datarate); Serial.print(" ");
    Serial.print(F("Counter: "));    Serial.print(counterup); Serial.print(" ");
    Serial.print(F("Power: "));    Serial.print(power); Serial.println(" dB");
  ...
  if (recvStatus) {
    ...
    datarate = lora.getDataRateRx();
    counterdown = lora.getFrameCounterRx();
    ...
    if (port != 0)
    {
      ...
      Serial.print(F("Freq: "));    Serial.print(freq); Serial.print(" ");
      Serial.print(F("DR: "));    Serial.print(datarate); Serial.print(" ");
      Serial.print(F("Counter: "));    Serial.print(counterdown); Serial.println(" ");
    }
    else
    {
